...
class Game:
    def __init__(self):
        ...
        self.message = "enter position here"
        self.gameboard = {}
        self.placePieces()
        print("chess! move each piece algebraically")
        self.main()
        ...
        while True:
            ...
            if target:
                ...
                if target.Color != self.playersturn:
                    self.message = "you arent allowed to move that piece this turn"
                    continue
...
class Piece:
    ...
    def availableMoves(self,x,y,gameboard):
        print("error; no movement for this base class")
